ntu_classes = ['drink water', 'eat meal', 'brush teeth', 'brush hair', 'drop', 'pick up', 'throw', 'sit down',
               ...
               'point to something', 'taking a selfie', 'check time (watch)', 'rub two hands', 'nod head/bow',
               ...
               'hush', 'flick hair', 'thumb up', 'thumb down', 'make OK sign', 'make victory sign', 'staple book',
               'counting money', 'cutting nails', 'cutting paper', 'snap fingers', 'open bottle', 'sniff/smell',
               ...
               'open a box', 'move heavy objects', 'shake fist', 'throw up cap/hat', 'capitulate', 'cross arms',
               'arm circles', 'arm swings', 'run on the spot', 'butt kicks', 'cross toe touch', 'side kick', 'yawn',
               'stretch oneself', 'blow nose', 'hit with object', 'wield knife', 'knock over', 'grab stuff',
               'shoot with gun', 'step on foot', 'high-five', 'cheers and drink', 'carry object', 'take a photo',
               'follow', 'whisper', 'exchange things', 'support somebody', 'rock-paper-scissors']
