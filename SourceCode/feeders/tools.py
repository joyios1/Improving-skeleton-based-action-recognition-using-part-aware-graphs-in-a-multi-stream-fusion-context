...
indices_of_arms = [5, 6, 7, 8, 9, 10, 11, 12, 21, 22, 23, 24, 25]
indices_of_arms = [i - 1 for i in indices_of_arms]

indices_of_legs = [1, 13, 14, 15, 16, 17, 18, 19, 20]
indices_of_legs = [i - 1 for i in indices_of_legs]

indices_of_right_hand_left_leg = [1, 2, 9, 10, 11, 12, 13, 14, 15, 16, 21, 24, 25]
indices_of_right_hand_left_leg = [i - 1 for i in indices_of_right_hand_left_leg]

indices_of_left_hand_right_leg = [1, 2, 5, 6, 7, 8, 17, 18, 19, 20, 21, 22, 23]
indices_of_left_hand_right_leg = [i - 1 for i in indices_of_left_hand_right_leg]
